        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            try
            {
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    string query = $"INSERT INTO {tableName} (ManagerID, firstName, lastName, DepartmentID) " +
                                   "VALUES (@managerID, @firstName, @lastName, @departmentID)";
        ...
        private void btnDelete_Click_1(object sender, EventArgs e)
        {
            try
            {
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    string query = $"DELETE FROM {tableName} WHERE ManagerID = @ManagerID";
