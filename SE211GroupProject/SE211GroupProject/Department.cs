...
namespace SE211GroupProject
{
    public partial class Department : Form
    {
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            try
            {
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    string employeeID = txtDepartmentID.Text;

                    string query = "INSERT INTO Department (DepartmentID, ManagerID, DepartmentName) " +
                                   "VALUES (@departmentID, @managerID, @departmentName)";
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    List<string> columns = new List<string> { "DepartmentID", "ManagerID", "DepartmentName" };
        ...
        {
            txtDepartmentID.Text = reader["EmployeeID"].ToString();
            txtManagerID.Text = reader["DepartmentID"].ToString();
            txtDepartmentName.Text = reader["firstName"].ToString();
